...
if __name__ == "__main__":
    ...
    # # load the poisson mesh quickly for debug
    # mesh_poisson = o3d.io.read_triangle_mesh(os.path.join(save_dir, "poisson_mesh_filter.ply"))
    ...
    # # load the clean mesh quickly for debug
    # mesh_poisson = o3d.io.read_triangle_mesh(os.path.join(save_dir, "filter_clean.ply"))
    # mesh_poisson = o3d.io.read_triangle_mesh(os.path.join(save_dir, "filter_clean_manually.ply"))
    ...
    for i, pose_file in pbar:
        ...
        if args.vis:
            ...
            # vis depth&normal
            # depth_rgb = (viridis_cmap(filter_depth) * 255).astype(np.uint8)
